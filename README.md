...
Constructs a command frame for use in [PN532.sendRequest()](#sendrequestrequestframe-responsecallback--numretries).
...
- *requestFrame*: A frame generated by [PN532.makeDataExchangeFrame()](# pn532makedataexchangeframetagnumber-data) or PN532.makeCommandFrame()](# pn532makecommandframecommand--data).
...
This should be constructed with a call to [`PN532CardEmulator.makeFelicaParams(nfcId2t, pad, systemCode)`](#pn532cardemulatormakefelicaparams(nfcid2t-pad-systemcode)).
